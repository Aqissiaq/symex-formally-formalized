...
\author{Åsmund Aqissiaq Arild Kløvstad
  \footnote{joint work with Einar Broch Johnsen and Eduard Kamburjan}
...
\begin{abstract}
  ...
  % \note{Traces are semantics presentation that can allow for composition~\cite{din2022lagc} and reordering of non-interfering events~\cite{Mazurkiewicz1977}.}
